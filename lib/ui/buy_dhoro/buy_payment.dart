...
class _BuyPaymentPageState extends State<BuyPaymentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      ...
      ngnConvertAmount = context.read(sharedProvider.userBuyProvider).ngnConvert;
      ...
      print("amount ... $amount");
      print("ngnConvertAmount ... $ngnConvertAmount");
    });
            ...
            children: [
              ...
              Container(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      AppFontsStyle.getAppTextViewBold("Kindly make a transfer of $ngnConvertAmount to the administrator account below:",
